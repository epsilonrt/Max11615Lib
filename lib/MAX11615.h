...
#define MAX11615_CHANNEL_AIN1       0x00    //Sets Channel to AIN1  | Reference is set via bit 0
#define MAX11615_CHANNEL_AIN2       0x00    //Sets Channel to AIN2  | Reference is set via bit 0
#define MAX11615_CHANNEL_AIN3       0x00    //Sets Channel to AIN3  | Reference is set via bit 0
#define MAX11615_CHANNEL_AIN4       0x00    //Sets Channel to AIN4  | Reference is set via bit 0
#define MAX11615_CHANNEL_AIN5       0x00    //Sets Channel to AIN5  | Reference is set via bit 0
#define MAX11615_CHANNEL_AIN6       0x00    //Sets Channel to AIN6  | Reference is set via bit 0
#define MAX11615_CHANNEL_AIN7       0x00    //Sets Channel to AIN7  | Reference is set via bit 0
#define MAX11615_CHANNEL_AIN8       0x00    //Sets Channel to AIN8  | Reference is set via bit 0
#define MAX11615_CHANNEL_AIN9       0x00    //Sets Channel to AIN9  | Reference is set via bit 0
#define MAX11615_CHANNEL_AIN10      0x00    //Sets Channel to AIN10 | Reference is set via bit 0
#define MAX11615_CHANNEL_AIN11      0x00    //Sets Channel to AIN11 | Reference is set via bit 0
